...
@Component({
  selector: 'app-quantiy.product',
  templateUrl: './quantiy.product.component.html',
  styleUrls: ['./quantiy.product.component.scss']
})
export class QuantiyProductComponent implements OnInit {
